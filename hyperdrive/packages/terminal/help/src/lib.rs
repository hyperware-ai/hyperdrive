...
const HELP_MESSAGES: [[&str; 2]; 14] = [
    ...
    ["schmecho", "\n\x1b[1mschmecho\x1b[0m <text>: print text to the terminal prefixed by 'schm'.\n    - Example: \x1b[1mschmecho foo\x1b[0m"],
    ...
    ["get-providers", "\n\x1b[1mget-providers\x1b[0m: list the current eth providers."],
    ["remove-provider", "\n\x1b[1mremove-provider\x1b[0m <chain-id> <node-id or rpc-url>: Remove a provider from the eth providers list."],
